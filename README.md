...
这不是一本用来「读」的书，而是一套用来「练」的训练系统。用得越多，价值越大。

### 三种使用方式

| 方式 | 适合人群 | 用法 |
| --- | --- | --- |
| **系统学习** | 想全面提升自己 | 按推荐顺序通读所有模块，完成实践任务 |
| **问题驱动** | 有具体问题要解决 | 从分类索引找到相关模块，直接用方法和工具 |
| **随手查阅** | 想找模板或清单 | 打开工具箱，直接复制使用 |

### 高效使用建议

1. **先扫目录再细读**：先了解整体结构，找到最需要的部分
2. **边读边做笔记**：每个模块至少写 3 条你马上能用的要点
3. **完成实践任务**：每个模块至少选 1-2 个实践任务去做
4. **用工具箱模板**：不要从零开始，直接复制模板修改使用
5. **定期复盘调整**：每月回顾进展，调整学习重点
6. **跨模块连接**：学到的知识要在不同模块之间建立关联

### 最低有效剂量

如果时间有限，至少做到这 5 件事：

- 填写 [能力自评表](./toolkit.md#能力自评表)，知道自己在哪
- 用 [问题定义卡](./toolkit.md#问题定义卡) 定义一个你真正想解决的问题
- 每周完成 1 个实践任务
- 每周写 1 篇复盘笔记
- 每月更新 1 次 [技能成长追踪表](./toolkit.md#技能成长追踪表)
...
| 模块 | 核心内容 | 适合谁先读 | 代表性工具 |
| --- | --- | --- | --- |
| **认知与学习** | 思维模型、学习方法、决策框架、认知偏差 | 所有人（基础） | 费曼技巧、决策矩阵 |
| **工程与技术** | 系统思维、项目管理、风险控制、验证方法 | 技术人、产品人 | MVP、优先级框架 |
| **商业与产品** | 用户理解、商业模式、增长策略、竞争分析 | 创业者、产品人 | 单位经济模型、AARRR |
| **经济与金融** | 宏观经济、资产配置、周期思维、财务分析 | 投资者、经营者 | 资产配置表、投资清单 |
| **社交与影响** | 沟通技巧、谈判、关系经营、情绪管理 | 所有人 | 沟通 7 习惯、冲突框架 |
| **创造与表达** | 写作、演讲、内容生产、审美判断 | 创作者、管理者 | 写作框架、演讲结构 |
| **自我管理** | 目标、时间、精力、习惯、复盘 | 所有人（基础） | OKR、时间审计表 |
| **健康与身心** | 睡眠、运动、营养、压力、心理韧性 | 所有人（基础） | 睡眠清单、运动计划 |
| **人文与社会** | 历史、哲学、政治、文化、制度 | 深度思考者 | 历史分析框架、概念词典 |
| **工具箱** | 模板、清单、训练方法 | 所有人 | 问题定义卡、复盘表 |
...
```text
第1步：认知与学习 → 第2步：自我管理 → 第3步：健康与身心
        ↓                    ↓                    ↓
     工具箱（边学边用）  工具箱（模板配合）  工具箱（健康追踪）
        ↓
第4步：选择你的方向模块
```

**为什么这样安排**：
1. 先学「认知与学习」——掌握学习方法，后面学什么都更快
2. 再学「自我管理」——有了目标和节奏，才能持续推进
3. 再学「健康与身心」——身体是基础，精力跟不上一切白搭
4. 最后根据目标选择能力层模块深入
...
| 你的目标 | 主攻模块 | 辅助模块 |
| --- | --- | --- |
| **想做产品/创业** | 商业与产品 + 工程与技术 | 经济 + 社交 + 创造 |
| **想做内容/创作** | 创造与表达 + 社交与影响 | 商业 + 人文 + 认知 |
| **想投资/理财** | 经济与金融 + 商业与产品 | 认知 + 人文 + 自我管理 |
| **想职场晋升** | 社交与影响 + 工程与技术 | 商业 + 自我管理 + 创造 |
| **想全面提升** | 认知 + 自我管理 + 健康 | 按兴趣选 2-3 个能力模块 |

### 模块阅读建议

- **基础层模块**（认知、自我管理、健康）：建议完整阅读，并至少完成 3 个实践任务
- **能力层模块**（工程、商业、经济、社交、创造、人文）：可以先读核心概念和实践任务，遇到问题再细读
- **工具箱**：随时查阅，用什么拿什么，不用从头读到尾

---

## 学习路径

不同目标的人，推荐不同的学习路径。找到你的路径，避免盲目学习。

### 路径一：技术创业者

```text
认知与学习 → 工程与技术 → 商业与产品 → 经济与金融 → 创造与表达
     ↓              ↓           ↓
  自我管理      工具箱       社交与影响
```

**重点**：先建立技术能力，再学商业思维，最后学会讲故事和融资。

### 路径二：内容创作者

```text
认知与学习 → 创造与表达 → 社交与影响 → 商业与产品 → 经济与金融
     ↓              ↓           ↓
  自我管理      工具箱       人文与社会
```

**重点**：先练表达和选题，再学传播和运营，最后理解商业变现。

### 路径三：职场晋升者

```text
自我管理 → 社交与影响 → 工程与技术 → 商业与产品 → 认知与学习
     ↓           ↓           ↓
  健康与身心  工具箱      经济与金融
```

**重点**：先提升执行力和协作能力，再补专业深度，最后建立跨域视角。

### 路径四：个人投资者

```text
认知与学习 → 经济与金融 → 商业与产品 → 人文与社会 → 自我管理
     ↓              ↓           ↓
  工具箱      工程与技术     健康与身心
```

**重点**：先建立经济和金融框架，再学企业分析，最后理解周期和人性。

### 路径五：终身学习者

```text
认知与学习 → 自我管理 → 健康与身心 → 人文与社会 → 按兴趣选择
     ↓          ↓          ↓
  工具箱    创造与表达   社交与影响
```

**重点**：先打好学习、管理和健康基础，再广泛探索，形成独特视角。

### 通用建议

无论哪条路径，都遵循这个原则：

1. **先基础后进阶**：认知、自我管理、健康是所有人的基础
2. **边学边做**：每学一个模块，至少完成一个实践任务
3. **交叉学习**：不要只学一条路径，适当跨界能产生新洞察
4. **定期复盘**：每季度回顾学到了什么、用上了什么、还缺什么
...
- 全模块版本统一升级到 v1.8
- README 新增「如何使用本手册」章节（三种使用方式 + 高效使用建议 + 最低有效剂量）
- README 新增「模块速查表」（核心内容、适合人群、代表性工具一览）
- README 新增「推荐阅读顺序」（零基础入门路径 + 按目标选择主攻方向 + 模块阅读建议）
- 所有 10 个模块新增目录导航，快速跳转到各章节
- 所有 10 个模块新增「返回首页」链接，提升导航体验
- 认知模块新增 3 个常见误区（迷信方法、追求速度、害怕犯错）
- 认知模块新增 4 个实践任务（费曼技巧练习、决策记录追踪、信息源分级、每日三问）
- 自我管理模块新增 3 个常见误区（完美主义、工具焦虑、缺乏边界）
- 自我管理模块新增 4 个实践任务（习惯追踪系统、个人 OKR 设定、精力审计、两分钟启动清单）
- 工具箱新增 3 个实用模板：复盘检查清单、个人商业模式画布、习惯养成追踪表
- 工具箱新增完整目录索引，共 23 个模板/工具一览

### v1.7 (2026-07-05)

- 全模块版本统一升级到 v1.7
- 增强跨模块关联性：每个模块新增 1-2 个相关模块链接
- 认知模块新增创造与表达、人文与社会关联
- 自我管理模块新增工程与技术、创造与表达关联
- 健康模块新增认知与学习、创造与表达关联
- 创造与表达模块新增认知与学习、自我管理、人文与社会关联
- 商业模块新增工程与技术、人文与社会关联
- 工程模块新增经济与金融、创造与表达关联
- 经济模块新增工程与技术、自我管理关联
- 社交模块新增认知与学习、健康与身心关联
- 人文模块新增认知与学习、创造与表达、商业与产品关联
- 工具箱新增关系经营模板、冲突复盘模板、学习计划模板

### v1.6 (2026-07-04)

- 健康模块新增营养入门（每日饮食结构、5 种常见饮食误区、饮水指南）
- 健康模块新增数字健康（屏幕使用原则、20-20-20 法则、信息断食方法）
- 经济模块新增经济周期（四阶段周期模型、6 项周期观察指标）
- 经济模块新增投资常见错误（8 种典型错误及纠正方法、投资检查清单）
- 社交模块新增困难对话指南（6 步准备框架 + 关键技巧）
- 社交模块新增跨文化沟通（5 大文化差异维度 + 5 条沟通原则）
- 人文模块新增人文思考方法（5 种核心方法 + 如何读一本人文著作）
- 人文模块新增历史分析框架（大历史视角 5 层分析 + 历史周期思维）
- README 新增学习路径章节（5 条个性化路径：技术创业/内容创作/职场晋升/个人投资/终身学习）
- 所有模块版本统一升级到 v1.6
