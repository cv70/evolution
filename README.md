...
这是一份面向个人长期成长的训练手册。它不追求把每个领域都学成专家，而是帮助一个人建立跨领域理解、判断、协作和创造的能力：看得懂复杂系统，能与不同专业的人合作，能把知识转化为作品、决策和影响力。
...
按模块阅读每个文件，选择一个当下最需要的能力开始训练。每个模块都包含“核心能力”“训练方法”“常见误区”和“实践任务”。建议每季度选择 2-3 个模块作为主线，不要同时追求所有能力。
